...
function getData(){
     ...
     $data[1] = $_POST['service_code'];
     $data[2] = $_POST['tariff_plan_code'];
     return $data;
}

if (isset($_POST['insert'])){
     $info = getData();
     $insert = "INSERT INTO [ServiceContract] ([contract_num],[service_code],[tariff_plan_code]) VALUES ('$info[0]', '$info[1]', '$info[2]')";
...
if (isset($_POST['delete'])){
     $info = getData();
     $delete = "DELETE FROM [ServiceContract] WHERE [contract_num] = '$info[1]'";
...
if (isset($_POST['update'])){
     $info = getData();
     $update = "UPDATE [ServiceContract] SET [contract_num] = '$info[0]', [service_code] = '$info[1]', [tariff_plan_code] = '$info[2]' WHERE [contract_num] = '$info[1]'";
...
<div class="container">
     <br>
     <h3 class="text-center mb-3">Ввод данных в таблицу Услуги и Договора</h3>
     <div class="row">
          <div class="col-sm">
               <form method="POST">
                    <br>
          ...
          <div class="col-sm">
               <br>
               <?php
               $query = "SELECT [contract_num],[service_code],[tariff_plan_code] FROM [ServiceContract]";
